...
#Region "メイン"
    ...
    Private Sub averagePricing(ByRef ret As history_t, entres As List(Of history_t))
        ...
        If 0 = add_entres.Count Then '現物買いが新規買い
            ...
            ret.enter_m_ct = ret.TANKA_ct * ret.volume '取得金額 ok
